...
onMounted(() => {
  if (inputGroup?.registerComponent) {
    inputGroup.registerComponent('select', componentId);
  }
});
...
const BASE_CLASSES = "w-full appearance-none border border-slate-200 bg-white transition-colors text-slate-700";
