...
export { default as DXDropdownDivider } from './DXDivider'; // Alias for backward compatibility
...
export { default as DXInputGroupAddon } from './DXInputAddon'; // Alias for backward compatibility
...
export { default as DXTagsList } from './DXTags'; // Alias for backward compatibility
