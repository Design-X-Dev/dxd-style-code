import{_ as n}from"./DXInput-BLwLEfW9.js";import{r}from"./vue.esm-bundler-CzLKT_w4.js";import{r as h}from"./EnvelopeIcon-DnmNmHRs.js";import{r as le}from"./CheckCircleIcon-C9JGObPW.js";import{r as Y}from"./MagnifyingGlassIcon-ssG6g_B7.js";import{r as Z}from"./MapPinIcon-h2Ljhq_w.js";import{r as ee}from"./PhoneIcon-BIGIDy9K.js";import{r as ne}from"./UserIcon-DiLxIH0K.js";import{r as re}from"./CurrencyDollarIcon-CZLhDret.js";import{r as oe,a as pe}from"./CreditCardIcon-qA3TuJUQ.js";import{r as te}from"./GlobeAltIcon-E9GBDZD6.js";import{r as ce}from"./LockClosedIcon-Dk5UallB.js";import"./useSize-DIMNv1Ms.js";import"./useClassComposition-Dym2pzZ_.js";import"./DXFormLabel-CkXlkm95.js";import"./DXIcon-BbhqsR95.js";import"./useAnimation-ByVAdqmf.js";import"./ExclamationCircleIcon-CzLk2qiN.js";import"./CheckCircleIcon-Ch9wT4dl.js";import"./DXIconWrapper-DA1ppaUf.js";const We={title:"Molecules/DXInput",component:n,tags:["autodocs","category:form"],argTypes:{size:{control:"select",options:["sm","md","lg"],description:"Размер поля"},disabled:{control:"boolean",description:"Отключенное состояние"},type:{control:"select",options:["text","email","number","tel","url"],description:"Тип input"}}},o={args:{placeholder:"Введите текст..."},render:e=>({components:{DXInput:n},setup(){return{args:e}},template:'<DXInput v-bind="args" />'})},a={args:{label:"Email",placeholder:"example@mail.com",type:"email"},render:e=>({components:{DXInput:n},setup(){return{args:e}},template:'<DXInput v-bind="args" />'})},l={args:{label:"Пароль",placeholder:"Минимум 8 символов",helper:"Используйте буквы, цифры и символы",type:"password"},render:e=>({components:{DXInput:n},setup(){return{args:e}},template:'<DXInput v-bind="args" />'})},p={args:{label:"Email",placeholder:"example@mail.com",error:"Неверный формат email",modelValue:"invalid-email"},render:e=>({components:{DXInput:n},setup(){return{args:e}},template:'<DXInput v-bind="args" />'})},t={args:{label:"Поле отключено",placeholder:"Нельзя редактировать",disabled:!0,modelValue:"Значение"},render:e=>({components:{DXInput:n},setup(){return{args:e}},template:'<DXInput v-bind="args" />'})},c={render:()=>({components:{DXInput:n},template:`
    ...
    `})},I={render:()=>({components:{DXInput:n},setup(){return{MagnifyingGlassIcon:Y,EnvelopeIcon:h,PhoneIcon:ee,UserIcon:ne,LockClosedIcon:ce,CreditCardIcon:oe,CalendarIcon:pe,MapPinIcon:Z,CurrencyDollarIcon:re,GlobeAltIcon:te}},template:`
...
}`,...(Q=(K=I.parameters)==null?void 0:K.docs)==null?void 0:Q.source}}};const Ae=["Default","WithLabel","WithHelper","WithError","Disabled","Sizes","WithPrefixIcon","WithSuffixIcon","Search","FormWithIcons","PaymentForm","AllIconTypes"];export{I as AllIconTypes,o as Default,t as Disabled,m as FormWithIcons,d as PaymentForm,i as Search,c as Sizes,p as WithError,l as WithHelper,a as WithLabel,s as WithPrefixIcon,u as WithSuffixIcon,Ae as __namedExportsOrder,We as default};
