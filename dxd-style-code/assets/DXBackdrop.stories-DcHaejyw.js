import{_ as o}from"./DXBackdrop-CWsT_mCr.js";import{_ as e}from"./DXButton-D4QV5g9V.js";import{r as n,c as G}from"./vue.esm-bundler-Nfu98kES.js";import"./useSize-D8MrabOp.js";import"./useVariant-DBYBwuJ6.js";import"./InformationCircleIcon-DsJgS0pw.js";import"./CheckCircleIcon-BeodL6Lf.js";import"./useClassComposition-Dym2pzZ_.js";const V={title:"Atoms/DXBackdrop",component:o,tags:["autodocs"],argTypes:{blur:{control:"select",options:["none","sm","md","lg","xl"],description:"Уровень размытия backdrop"},backgroundColor:{control:"text",description:"Цвет фона (Tailwind класс или CSS значение): bg-slate-900/40 | bg-black/50 | rgb(...)"},zIndex:{control:"select",options:["0","10","20","30","40","50","auto"],description:"z-index backdrop"},dismissible:{control:"boolean",description:"Можно ли закрыть кликом"},lockScroll:{control:"boolean",description:"Блокировать скролл body"}}},r={render:()=>({components:{DXBackdrop:o,DXButton:e},setup(){return{show:n(!1)}},template:`
      <div>
...
}`,...(g=(X=c.parameters)==null?void 0:X.docs)==null?void 0:g.source}}};var C,y,E;a.parameters={...a.parameters,docs:{...(C=a.parameters)==null?void 0:C.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXBackdrop,
      DXButton
...
}`,...(E=(y=a.parameters)==null?void 0:y.docs)==null?void 0:E.source}}};var A,z,j;d.parameters={...d.parameters,docs:{...(A=d.parameters)==null?void 0:A.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXBackdrop,
      DXButton
