import{_ as e}from"./DXPagination-Du3-Wl5M.js";import{r as s}from"./vue.esm-bundler-CzLKT_w4.js";import"./DXIcon-BbhqsR95.js";import"./useSize-DIMNv1Ms.js";import"./useAnimation-ByVAdqmf.js";import"./ChevronLeftIcon-BRnQlYlk.js";import"./ChevronRightIcon-3JO9-dGk.js";const E={title:"Molecules/DXPagination",component:e,tags:["autodocs"],argTypes:{size:{control:{type:"select"},options:["sm","md","lg"]}}},a={render:()=>({components:{DXPagination:e},setup(){return{page:s(1)}},template:'<DXPagination v-model="page" :total-pages="10" />'})},n={render:()=>({components:{DXPagination:e},setup(){return{page:s(5)}},template:'<DXPagination v-model="page" :total-pages="10" />'})},t={render:()=>({components:{DXPagination:e},setup(){return{page:s(15)}},template:'<DXPagination v-model="page" :total-pages="50" />'})},o={render:()=>({components:{DXPagination:e},setup(){return{page:s(1)}},template:`
      <div class="space-y-4">
