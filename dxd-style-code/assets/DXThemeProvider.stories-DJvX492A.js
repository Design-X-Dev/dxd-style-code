...
Тема может быть изменена динамически, все CSS переменные обновляются автоматически.
    ...
    `})},h={parameters:{docs:{description:{story:"Использование темы через inject в дочерних компонентах."}}},render:()=>({components:{DXThemeProvider:m,DXCard:p,DXButton:v},setup(){return{themes:n(y),ThemedComponent:{setup(){return{theme:G("theme")}},template:`
          <DXCard class="p-4" style="background-color: var(--color-surface, #f9fafb);">
    ...
    `})};var B,E,x;d.parameters={...d.parameters,docs:{...(B=d.parameters)==null?void 0:B.docs,source:{originalSource:`{
  args: {
    theme: 'light',
...
}`,...(x=(E=d.parameters)==null?void 0:E.docs)==null?void 0:x.source}}};var S,P,F;i.parameters={...i.parameters,docs:{...(S=i.parameters)==null?void 0:S.docs,source:{originalSource:`{
  args: {
    theme: 'light',
    themes: defaultThemes,
    persist: true
...
}`,...(A=(j=h.parameters)==null?void 0:j.docs)==null?void 0:A.source}}};var N,V,I;f.parameters={...f.parameters,docs:{...(N=f.parameters)==null?void 0:N.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(I=(V=f.parameters)==null?void 0:V.docs)==null?void 0:I.source}}};const ce=["Default","WithPersistence","WithInject","CustomThemes"];export{f as CustomThemes,d as Default,h as WithInject,i as WithPersistence,ce as __namedExportsOrder,se as default};
