import{r as D,c as l,a as v,o as s,p as c,b as p,q as C,g as T,F as ie,G as de,j as r,S as me,A as ce,B as pe,e as i,y as d,z as k,d as E}from"./vue.esm-bundler-C1fUoNF-.js";import{u as h}from"./useClassComposition-Dym2pzZ_.js";import{u as fe}from"./useSpacing-BOHUzi8w.js";import{_ as ge}from"./DXTextarea-D9Exn-g-.js";import{_ as y}from"./DXButton-DzgLKRkE.js";import{_ as ve}from"./DXAvatar-CBvTh_o7.js";import{_ as R}from"./DXText-Bu-Qlv6N.js";import{_ as Ce}from"./DXPagination-C9wlZ4pU.js";import"./DXFormLabel-DO2rZe0p.js";import"./DXIcon-Bc0cQL8C.js";import"./useSize-DIMNv1Ms.js";import"./useAnimation-ByVAdqmf.js";import"./ExclamationCircleIcon-4GpTxUBf.js";import"./CheckCircleIcon-BfzIyqt6.js";import"./DXIconWrapper-Dj2l5Guj.js";import"./useVariant-2nzc00zP.js";import"./InformationCircleIcon-BdSdF6Ec.js";import"./DXNav-rdhJaqaA.js";import"./ChevronLeftIcon-DZ_29e3J.js";import"./ChevronRightIcon-i770bDiF.js";const he=["data-threading"],ye={class:"space-y-3"},De={class:"flex items-center justify-end gap-2"},we={class:"flex gap-3"},be={class:"flex-1"},Se={class:"flex items-center gap-2 mb-1"},ke={class:"flex items-center gap-4"},w={__name:"DXCommentSection",props:{comments:{type:Array,required:!0,default:()=>[]},threading:{type:Boolean,default:!0},sortBy:{type:String,default:"newest",validator:n=>["newest","oldest","popular"].includes(n)},filterBy:{type:String,default:""},showForm:{type:Boolean,default:!0},formPlaceholder:{type:String,default:"Добавить комментарий..."},formRows:{type:Number,default:3},editable:{type:Boolean,default:!1},deletable:{type:Boolean,default:!1},showReactions:{type:Boolean,default:!0},paginated:{type:Boolean,default:!1},pageSize:{type:Number,default:10}},emits:["add-comment","reply","edit","delete","like","page-change"],setup(n,{emit:_}){const o=n,m=_,f=D(""),b=D(1),S=D(null),P=l(()=>{const e=[...o.comments];switch(o.sortBy){case"oldest":return e.sort((t,u)=>new Date(t.date)-new Date(u.date));case"popular":return e.sort((t,u)=>(u.likes||0)-(t.likes||0));case"newest":default:return e.sort((t,u)=>new Date(u.date)-new Date(t.date))}}),x=l(()=>o.filterBy?P.value.filter(e=>{var t,u;return(u=(t=e.author)==null?void 0:t.name)==null?void 0:u.toLowerCase().includes(o.filterBy.toLowerCase())}):P.value),Q=l(()=>{if(!o.paginated)return x.value;const e=(b.value-1)*o.pageSize,t=e+o.pageSize;return x.value.slice(e,t)}),j=l(()=>o.paginated?Math.ceil(x.value.length/o.pageSize):1),Y=l(()=>h("w-full space-y-6")),Z=l(()=>h("mb-6",fe("md","padding"))),ee=l(()=>h("space-y-4"));function te(e){return h("pb-4",e.parentId?"ml-8 border-l-2 border-slate-200 pl-4":"")}const ne=l(()=>h("mt-4 ml-8 space-y-4")),ae=l(()=>h("mt-6 flex justify-center"));function oe(e){return e?new Date(e).toLocaleDateString("ru-RU",{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"}):""}function N(){f.value.trim()&&(m("add-comment",{text:f.value,parentId:S.value}),f.value="",S.value=null)}function ue(){f.value="",S.value=null}function A(e){S.value=e,m("reply",e)}function z(e){m("edit",e)}function F(e){m("delete",e)}function se(e){m("like",e)}function le(e){m("add-comment",e)}function re(e){b.value=e,m("page-change",e)}return(e,t)=>{const u=me("DXCommentSection",!0);return s(),v("div",{class:C(Y.value),"data-component":"DXCommentSection","data-threading":n.threading},[n.showForm||e.$slots["comment-form"]?(s(),v("div",{key:0,class:C(Z.value)},[T(e.$slots,"comment-form",{},()=>[p("div",ye,[r(ge,{modelValue:f.value,"onUpdate:modelValue":t[0]||(t[0]=a=>f.value=a),placeholder:n.formPlaceholder,rows:n.formRows,onKeydown:ce(pe(N,["ctrl"]),["enter"])},null,8,["modelValue","placeholder","rows","onKeydown"]),p("div",De,[r(y,{variant:"ghost",onClick:ue},{default:i(()=>[...t[2]||(t[2]=[d(" Отмена ",-1)])]),_:1}),r(y,{variant:"primary",onClick:N},{default:i(()=>[...t[3]||(t[3]=[d(" Отправить ",-1)])]),_:1})])])])],2)):c("",!0),p("div",{class:C(ee.value)},[(s(!0),v(ie,null,de(Q.value,a=>(s(),v("div",{key:a.id,class:C(te(a))},[T(e.$slots,"comment",{comment:a,reply:A,edit:z,delete:F},()=>{var L,U;return[p("div",we,[r(ve,{src:(L=a.author)==null?void 0:L.avatar,name:(U=a.author)==null?void 0:U.name,size:"md"},null,8,["src","name"]),p("div",be,[p("div",Se,[r(R,{tag:"span",weight:"semibold",color:"default"},{default:i(()=>{var g;return[d(k(((g=a.author)==null?void 0:g.name)||"Аноним"),1)]}),_:2},1024),r(R,{tag:"span",size:"xs",color:"muted"},{default:i(()=>[d(k(oe(a.date)),1)]),_:2},1024)]),r(R,{tag:"div",size:"sm",color:"default",class:"mb-2"},{default:i(()=>[d(k(a.text),1)]),_:2},1024),p("div",ke,[n.showReactions?(s(),E(y,{key:0,size:"sm",variant:"ghost",onClick:g=>se(a.id)},{default:i(()=>[d(" 👍 "+k(a.likes||0),1)]),_:2},1032,["onClick"])):c("",!0),n.threading?(s(),E(y,{key:1,size:"sm",variant:"ghost",onClick:g=>A(a.id)},{default:i(()=>[...t[4]||(t[4]=[d(" Ответить ",-1)])]),_:1},8,["onClick"])):c("",!0),n.editable&&a.canEdit?(s(),E(y,{key:2,size:"sm",variant:"ghost",onClick:g=>z(a.id)},{default:i(()=>[...t[5]||(t[5]=[d(" Редактировать ",-1)])]),_:1},8,["onClick"])):c("",!0),n.deletable&&a.canDelete?(s(),E(y,{key:3,size:"sm",variant:"ghost",onClick:g=>F(a.id)},{default:i(()=>[...t[6]||(t[6]=[d(" Удалить ",-1)])]),_:1},8,["onClick"])):c("",!0)])])])]}),n.threading&&a.replies&&a.replies.length>0?(s(),v("div",{key:0,class:C(ne.value)},[r(u,{comments:a.replies,threading:n.threading,editable:n.editable,deletable:n.deletable,"show-reactions":n.showReactions,onAddComment:le,onReply:A,onEdit:z,onDelete:F},null,8,["comments","threading","editable","deletable","show-reactions"])],2)):c("",!0)],2))),128))],2),n.paginated&&j.value>1?(s(),v("div",{key:1,class:C(ae.value)},[r(Ce,{modelValue:b.value,"onUpdate:modelValue":[t[1]||(t[1]=a=>b.value=a),re],"total-pages":j.value},null,8,["modelValue","total-pages"])],2)):c("",!0)],10,he)}}};w.__docgenInfo={exportName:"default",displayName:"DXCommentSection",description:"",tags:{},props:[{name:"comments",description:`Комментарии
Формат: [{ id, text, author: { name, avatar }, date, likes?, replies?, canEdit?, canDelete? }]`,type:{name:"array"},required:!0,defaultValue:{func:!1,value:"[]"}},{name:"threading",description:"Поддержка вложенности (threading)",tags:{default:[{description:"true",title:"default"}]},type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"sortBy",description:"Сортировка: newest | oldest | popular",tags:{default:[{description:"'newest'",title:"default"}]},type:{name:"string"},defaultValue:{func:!1,value:'"newest"'},values:["newest","oldest","popular"]},{name:"filterBy",description:"Фильтр по автору",type:{name:"string"},defaultValue:{func:!1,value:'""'}},{name:"showForm",description:"Показывать форму добавления",tags:{default:[{description:"true",title:"default"}]},type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"formPlaceholder",description:"Placeholder для формы",type:{name:"string"},defaultValue:{func:!1,value:'"Добавить комментарий..."'}},{name:"formRows",description:"Количество строк в форме",tags:{default:[{description:"3",title:"default"}]},type:{name:"number"},defaultValue:{func:!1,value:"3"}},{name:"editable",description:"Можно редактировать комментарии",tags:{default:[{description:"false",title:"default"}]},type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"deletable",description:"Можно удалять комментарии",tags:{default:[{description:"false",title:"default"}]},type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"showReactions",description:"Показывать реакции (лайки)",tags:{default:[{description:"true",title:"default"}]},type:{name:"boolean"},defaultValue:{func:!1,value:"true"}},{name:"paginated",description:"Пагинация",tags:{default:[{description:"false",title:"default"}]},type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"pageSize",description:"Количество комментариев на странице",tags:{default:[{description:"10",title:"default"}]},type:{name:"number"},defaultValue:{func:!1,value:"10"}}],events:[{name:"add-comment"},{name:"reply"},{name:"edit"},{name:"delete"},{name:"like"},{name:"page-change"}],slots:[{name:"comment-form"},{name:"comment",scoped:!0,bindings:[{name:"comment",title:"binding"},{name:"reply",title:"binding"},{name:"edit",title:"binding"},{name:"delete",title:"binding"}]}],sourceFiles:["/Users/lea_alex/Projects/1_DEVELOP/0_DESIGN_X_DEV/dxd-style-code/src/components/organisms/DXCommentSection/DXCommentSection.vue"]};const qe={title:"Organisms/DXCommentSection",component:w,tags:["autodocs","category:feedback"],parameters:{docs:{description:{component:`
# DXCommentSection
...
При \`showReactions={true}\` показываются лайки.
      ...
      />
    `})},B={parameters:{docs:{description:{story:"Секция комментариев с поддержкой вложенности (ответы на комментарии)."}}},render:()=>({components:{DXCommentSection:w},setup(){return{comments:D($)}},template:`
      <DXCommentSection
        :comments="comments"
        :threading="true"
      />
...
}`,...(W=(M=X.parameters)==null?void 0:M.docs)==null?void 0:W.source}}};var q,K,O;B.parameters={...B.parameters,docs:{...(q=B.parameters)==null?void 0:q.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(O=(K=B.parameters)==null?void 0:K.docs)==null?void 0:O.source}}};var G,J,H;V.parameters={...V.parameters,docs:{...(G=V.parameters)==null?void 0:G.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(H=(J=V.parameters)==null?void 0:J.docs)==null?void 0:H.source}}};const Ke=["Default","WithThreading","WithModeration"];export{X as Default,V as WithModeration,B as WithThreading,Ke as __namedExportsOrder,qe as default};
