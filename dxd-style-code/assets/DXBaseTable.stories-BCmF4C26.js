import{r as m}from"./vue.esm-bundler-CzLKT_w4.js";import{D as a}from"./DXBaseTable-CQ7MQRkz.js";import{_ as he}from"./DXBadge-CxZg7KEC.js";import"./DXIcon-BbhqsR95.js";import"./useSize-DIMNv1Ms.js";import"./useAnimation-ByVAdqmf.js";import"./DXCheckbox-ztLTdipt.js";import"./useVariant-vdsOb9m8.js";import"./InformationCircleIcon-BhW4k1dY.js";import"./CheckCircleIcon-Ch9wT4dl.js";import"./CheckIcon-CKhG8hn0.js";import"./DXDropdown-BME4Lvuj.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";import"./ChevronDownIcon-oXhPA-Up.js";import"./DXDropdownItem-CaNyf6TV.js";import"./useClassComposition-Dym2pzZ_.js";import"./ChevronRightIcon-3JO9-dGk.js";import"./DXDropdownDivider-CNjXQi0n.js";import"./DXDivider-Yv-XXyN6.js";import"./useSpacing-BOHUzi8w.js";import"./DXLoader-BMlBTXd1.js";import"./DXSearchSelect-u2V-p1fX.js";import"./PencilIcon-CpxY3S_F.js";import"./TrashIcon-NtQ19PgI.js";const Je={title:"Molecules/DXBaseTable",component:a,tags:["autodocs"]},Te=[{key:"name",label:"Имя"},{key:"email",label:"Email"},{key:"role",label:"Роль"}],l=[{key:"id",label:"ID",width:"80px",sortable:!0},{key:"name",label:"Имя",sortable:!0},{key:"email",label:"Email",sortable:!0},{key:"role",label:"Роль",sortable:!0},{key:"status",label:"Статус",sortable:!0},{key:"age",label:"Возраст",sortable:!0,width:"100px",align:"center"}],r=[{id:1,name:"Иван Иванов",email:"ivan@example.com",role:"Admin",status:"Active",age:32},{id:2,name:"Мария Петрова",email:"maria@example.com",role:"User",status:"Active",age:28},{id:3,name:"Петр Сидоров",email:"petr@example.com",role:"User",status:"Inactive",age:45},{id:4,name:"Анна Смирнова",email:"anna@example.com",role:"Manager",status:"Active",age:35},{id:5,name:"Дмитрий Козлов",email:"dmitry@example.com",role:"User",status:"Pending",age:29}],Xe=Array.from({length:20},(t,e)=>({id:e+1,name:`Пользователь ${e+1}`,email:`user${e+1}@example.com`,role:["Admin","User","Manager"][e%3],status:["Active","Inactive","Pending"][e%3],age:20+e%50,category:["Tech","Sales","Marketing"][e%3]})),p={render:()=>({components:{DXBaseTable:a},setup(){return{simpleColumns:Te,simpleData:r}},template:`
      <DXBaseTable
        :columns="simpleColumns"
        :data="simpleData"
      />
    `})},D={render:()=>({components:{DXBaseTable:a},setup(){const t=m("name"),e=m("asc"),n=m([...r]);return{columns:l,data:n,sortBy:t,sortDirection:e,handleSort:({column:u,direction:i})=>{t.value=u,e.value=i,n.value=[...n.value].sort((x,V)=>{const s=x[u],c=V[u],d=i==="asc"?1:-1;return s<c?-1*d:s>c?1*d:0})}}},template:`
      <DXBaseTable
        :columns="columns"
        :data="data"
        :sortBy="sortBy"
        ...
        @sort="handleSort"
      />
    `})},b={render:()=>({components:{DXBaseTable:a},setup(){const t=m([]);return{columns:l,data:r,selectedRows:t,handleRowSelect:({id:o,selected:u})=>{u?t.value.push(o):t.value=t.value.filter(i=>i!==o)},handleSelectAll:o=>{o?t.value=r.map(u=>u.id):t.value=[]}}},template:`
      <div>
    ...
    `})},y={render:()=>({components:{DXBaseTable:a,DXBadge:he},setup(){const t=m("name"),e=m("asc"),n=m([]),o=m([...r]);return{columns:l,data:o,sortBy:t,sortDirection:e,selectedRows:n,handleSort:({column:s,direction:c})=>{t.value=s,e.value=c,o.value=[...o.value].sort((d,we)=>{const A=d[s],E=we[s],C=c==="asc"?1:-1;return A<E?-1*C:A>E?1*C:0})},handleRowSelect:({id:s,selected:c})=>{c?n.value.push(s):n.value=n.value.filter(d=>d!==s)},handleSelectAll:s=>{s?n.value=o.value.map(c=>c.id):n.value=[]},getStatusVariant:s=>({Active:"success",Inactive:"neutral",Pending:"warning"})[s]||"neutral"}},template:`
      <DXBaseTable
        :columns="columns"
        :data="data"
        :sortBy="sortBy"
...
}`,...(oe=(re=w.parameters)==null?void 0:re.docs)==null?void 0:oe.source}}};var ce,ue,me;T.parameters={...T.parameters,docs:{...(ce=T.parameters)==null?void 0:ce.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXBaseTable
    },
...
}`,...(me=(ue=T.parameters)==null?void 0:ue.docs)==null?void 0:me.source}}};var de,ie,pe;f.parameters={...f.parameters,docs:{...(de=f.parameters)==null?void 0:de.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXBaseTable
    },
