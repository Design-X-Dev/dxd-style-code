import{_ as a}from"./DXSearchSelect-Cl2oWNWm.js";import{r as n}from"./vue.esm-bundler-C1fUoNF-.js";const b={title:"Molecules/DXSearchSelect",component:a,tags:["autodocs"],parameters:{docs:{description:{component:`
# DXSearchSelect
...
- Поисковая строка не закрывает dropdown при вводе
        `}}}},t=[{value:"1",label:"John Doe"},{value:"2",label:"Jane Smith"},{value:"3",label:"Bob Johnson"},{value:"4",label:"Alice Williams"},{value:"5",label:"Charlie Brown"}],e={render:()=>({components:{DXSearchSelect:a},setup(){return{value:n(""),users:t}},template:'<DXSearchSelect v-model="value" :options="users" label="Select User" placeholder="Search users..." />'})},r={render:()=>({components:{DXSearchSelect:a},setup(){return{value:n("2"),users:t}},template:'<DXSearchSelect v-model="value" :options="users" label="Assigned To" />'})},l={render:()=>({components:{DXSearchSelect:a},setup(){return{value:n([]),users:t}},template:'<DXSearchSelect v-model="value" :options="users" label="Team Members" multiple />'})};var o,c,u;e.parameters={...e.parameters,docs:{...(o=e.parameters)==null?void 0:o.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXSearchSelect
    },
...
}`,...(S=(m=r.parameters)==null?void 0:m.docs)==null?void 0:S.source}}};var i,d,v;l.parameters={...l.parameters,docs:{...(i=l.parameters)==null?void 0:i.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXSearchSelect
    },
...
}`,...(v=(d=l.parameters)==null?void 0:d.docs)==null?void 0:v.source}}};const X=["Default","WithValue","Multiple"];export{e as Default,l as Multiple,r as WithValue,X as __namedExportsOrder,b as default};
