import{_ as o}from"./DXSpacer-Cmns9whx.js";import"./vue.esm-bundler-C1fUoNF-.js";import"./useClassComposition-Dym2pzZ_.js";const g={title:"Atoms/DXSpacer",component:o,tags:["autodocs","category:layout"],parameters:{docs:{description:{component:`
...
- Компонент имеет \`aria-hidden="true"\` для скринридеров (не является семантическим элементом)
    ...
    `})},r={parameters:{docs:{description:{story:"DXSpacer с flex-grow режимом. Заполняет все доступное пространство между элементами в flex контейнере. Полезен для создания макетов, где элементы должны быть по краям, а пространство между ними заполняется автоматически. В этом режиме размеры игнорируются."}}},render:()=>({components:{DXSpacer:o},template:`
      <div class="flex">
        <div class="bg-slate-100 p-4 rounded">Start</div>
        <DXSpacer grow />
        <div class="bg-slate-100 p-4 rounded">End</div>
      </div>
    `})};var a,s,t;u.parameters={...u.parameters,docs:{...(a=u.parameters)==null?void 0:a.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(t=(s=u.parameters)==null?void 0:s.docs)==null?void 0:t.source}}};var n,i,d;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(d=(i=e.parameters)==null?void 0:i.docs)==null?void 0:d.source}}};var l,c,p;r.parameters={...r.parameters,docs:{...(l=r.parameters)==null?void 0:l.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(p=(c=r.parameters)==null?void 0:c.docs)==null?void 0:p.source}}};const E=["Vertical","Horizontal","FlexGrow"];export{r as FlexGrow,e as Horizontal,u as Vertical,E as __namedExportsOrder,g as default};
