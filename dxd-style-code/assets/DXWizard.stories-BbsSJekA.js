import{r as i,c as o,s as ce,w as I,a as p,p as D,b as m,q as f,j as A,z as g,F as me,G as ve,e as S,T as fe,g as O,o as s,d as b,x as ge,y as w}from"./vue.esm-bundler-C1fUoNF-.js";import{u as h}from"./useClassComposition-Dym2pzZ_.js";import{u as De}from"./useSpacing-BOHUzi8w.js";import{_ as he}from"./DXProgress-kFfDE3m6.js";import{_ as x}from"./DXButton-DzgLKRkE.js";import{_ as Se}from"./DXIcon-Bc0cQL8C.js";import{r as be}from"./CheckIcon-B1lKtPCn.js";import{_ as H}from"./DXInput-BG2R0LGs.js";import{_ as Q}from"./DXFormControl-Dg_VsVTj.js";import"./useSize-DIMNv1Ms.js";import"./useAnimation-ByVAdqmf.js";import"./useVariant-2nzc00zP.js";import"./InformationCircleIcon-BdSdF6Ec.js";import"./CheckCircleIcon-BfzIyqt6.js";import"./DXFormLabel-DO2rZe0p.js";import"./ExclamationCircleIcon-4GpTxUBf.js";import"./DXIconWrapper-Dj2l5Guj.js";import"./DXText-Bu-Qlv6N.js";import"./DXValidationIcon-n1eDkzYR.js";const ze=["data-current-step"],we={key:0,class:"mt-2 text-sm text-slate-600 text-center"},xe={key:1,class:"text-sm font-medium"},ye={class:"flex-1 ml-4"},Ce={class:"text-sm font-medium text-slate-900"},Ee={key:0,class:"text-xs text-slate-500"},Xe={class:"p-8 text-center text-slate-500"},Fe={class:"text-sm mt-2"},z={__name:"DXWizard",props:{steps:{type:Array,required:!0},currentStep:{type:Number,default:1},wizardData:{type:Object,default:()=>({})},validationErrors:{type:Object,default:()=>({})},allowSkip:{type:Boolean,default:!1},saveProgressEnabled:{type:Boolean,default:!1},storageKey:{type:String,default:"dx-wizard-progress"},loading:{type:Boolean,default:!1},showProgress:{type:Boolean,default:!0},showProgressLabel:{type:Boolean,default:!0},showStepsIndicator:{type:Boolean,default:!0},transition:{type:String,default:"fade"}},emits:["update:currentStep","update:wizardData","next","prev","complete","cancel","step-change","save-progress"],setup(e,{emit:v}){const u=e,r=v,a=i(u.currentStep),l=i({...u.wizardData}),R=o(()=>u.steps.length===0?0:(a.value-1)/u.steps.length*100),Y=o(()=>"sm"),X=o(()=>u.steps[a.value-1]||{}),k=o(()=>{var c;const t={},n=((c=X.value)==null?void 0:c.fields)||Object.keys(l.value);for(const d of n)u.validationErrors[d]&&(t[d]=u.validationErrors[d]);return t}),F=o(()=>u.allowSkip?!0:Object.keys(k.value).length===0),Z=o(()=>a.value>1),j=o(()=>Object.keys(u.validationErrors).length===0),_=o(()=>u.transition),ee=o(()=>h("w-full",De("md","padding"))),te=o(()=>h("mb-6")),ae=o(()=>h("mb-8 relative"));function ue(t){return h("flex items-center relative mb-6",t===a.value-1?"text-slate-900":"text-slate-500")}function ne(t){const n=t+1;return n<a.value?"w-10 h-10 bg-green-500 text-white":n===a.value?"w-10 h-10 bg-blue-500 text-white":"w-10 h-10 bg-slate-200 text-slate-500"}function re(t){return t+1<a.value?"bg-green-500":"bg-slate-200"}const se=o(()=>h("min-h-[300px]")),le=o(()=>h("flex items-center justify-between gap-4 mt-8 pt-6 border-t border-slate-200"));function oe(t){return t+1<a.value}function B(){a.value<u.steps.length&&F.value&&(a.value++,r("update:currentStep",a.value),r("next",a.value),r("step-change",a.value),W())}function V(){a.value>1&&(a.value--,r("update:currentStep",a.value),r("prev",a.value),r("step-change",a.value),W())}function ie(t){t>=1&&t<=u.steps.length&&(a.value=t,r("update:currentStep",a.value),r("step-change",a.value),W())}function N(){const t={currentStep:a.value,wizardData:{...l.value}};localStorage.setItem(u.storageKey,JSON.stringify(t)),r("save-progress",t)}function W(){u.saveProgressEnabled&&N()}function de(){j.value&&(r("complete",{wizardData:{...l.value},currentStep:a.value}),u.saveProgressEnabled&&localStorage.removeItem(u.storageKey))}function pe(){r("cancel")}return ce(()=>{if(u.saveProgressEnabled){const t=localStorage.getItem(u.storageKey);if(t)try{const n=JSON.parse(t);n.currentStep&&(a.value=n.currentStep,r("update:currentStep",a.value)),n.wizardData&&(l.value={...n.wizardData},r("update:wizardData",{...l.value}))}catch(n){console.warn("Не удалось загрузить сохраненный прогресс:",n)}}}),I(()=>u.currentStep,t=>{t!==a.value&&(a.value=t)}),I(()=>u.wizardData,t=>{l.value={...t}},{deep:!0}),I(l,t=>{r("update:wizardData",{...t})},{deep:!0}),(t,n)=>(s(),p("div",{class:f(ee.value),"data-component":"DXWizard","data-current-step":e.currentStep},[e.showProgress?(s(),p("div",{key:0,class:f(te.value)},[A(he,{value:R.value,max:100,size:Y.value,"show-label":e.showProgressLabel},null,8,["value","size","show-label"]),e.showProgressLabel?(s(),p("div",we," Шаг "+g(e.currentStep)+" из "+g(e.steps.length),1)):D("",!0)],2)):D("",!0),e.showStepsIndicator?(s(),p("div",{key:1,class:f(ae.value)},[(s(!0),p(me,null,ve(e.steps,(c,d)=>(s(),p("div",{key:d,class:f(ue(d))},[m("div",{class:f([ne(d),"flex items-center justify-center rounded-full"])},[oe(d)?(s(),b(Se,{key:0,icon:ge(be),size:"sm",class:"text-white"},null,8,["icon"])):(s(),p("span",xe,g(d+1),1))],2),m("div",ye,[m("div",Ce,g(c.title),1),c.description?(s(),p("div",Ee,g(c.description),1)):D("",!0)]),d<e.steps.length-1?(s(),p("div",{key:0,class:f([re(d),"absolute left-5 top-10 w-0.5 h-full"])},null,2)):D("",!0)],2))),128))],2)):D("",!0),m("div",{class:f(se.value)},[A(fe,{name:_.value,mode:"out-in"},{default:S(()=>[(s(),p("div",{key:e.currentStep,class:"w-full"},[O(t.$slots,`step-${e.currentStep}`,{step:X.value,stepIndex:e.currentStep-1,formData:e.wizardData,errors:k.value},()=>{var c;return[m("div",Xe,[m("p",null,"Шаг "+g(e.currentStep)+": "+g((c=X.value)==null?void 0:c.title),1),m("p",Fe," Используйте slot step-"+g(e.currentStep)+" для контента ",1)])]})]))]),_:3},8,["name"])],2),m("div",{class:f(le.value)},[O(t.$slots,"navigation",{canGoNext:F.value,canGoPrev:Z.value,goNext:B,goPrev:V,goToStep:ie,currentStep:e.currentStep,totalSteps:e.steps.length,save:N,cancel:pe},()=>[e.currentStep>1?(s(),b(x,{key:0,variant:"ghost",disabled:e.loading,onClick:V},{default:S(()=>[...n[0]||(n[0]=[w(" Назад ",-1)])]),_:1},8,["disabled"])):D("",!0),n[4]||(n[4]=m("div",{class:"flex-1"},null,-1)),e.saveProgressEnabled?(s(),b(x,{key:1,variant:"ghost",disabled:e.loading,onClick:N},{default:S(()=>[...n[1]||(n[1]=[w(" Сохранить прогресс ",-1)])]),_:1},8,["disabled"])):D("",!0),e.currentStep<e.steps.length?(s(),b(x,{key:2,variant:"primary",disabled:e.loading||!F.value,onClick:B},{default:S(()=>[...n[2]||(n[2]=[w(" Далее ",-1)])]),_:1},8,["disabled"])):(s(),b(x,{key:3,variant:"success",disabled:e.loading||!j.value,onClick:de},{default:S(()=>[...n[3]||(n[3]=[w(" Завершить ",-1)])]),_:1},8,["disabled"]))])],2)],10,ze))}};z.__docgenInfo={exportName:"default",displayName:"DXWizard",description:"",tags:{},props:[{name:"steps",description:`Шаги мастера
...
При включенном сохранении прогресс сохраняется автоматически при переходе между шагами.
    ...
    `})},C={parameters:{docs:{description:{story:"Мастер с сохранением прогресса. Прогресс сохраняется автоматически при переходе между шагами."}}},render:()=>({components:{DXWizard:z},setup(){const e=i(1),v=i({}),u=i(P);return{currentStep:e,wizardData:v,steps:u}},template:`
      <DXWizard
        v-model:current-step="currentStep"
        v-model:wizard-data="wizardData"
        :steps="steps"
      ...
      />
    `})},E={parameters:{docs:{description:{story:"Мастер с валидацией. Нельзя перейти к следующему шагу, если текущий не валиден."}}},render:()=>({components:{DXWizard:z,DXInput:H,DXFormControl:Q},setup(){const e=i(1),v=i({projectName:""}),u=i({}),r=i(P);return{currentStep:e,wizardData:v,validationErrors:u,steps:r,handleStepChange:l=>{l===2&&!v.value.projectName?u.value.projectName="Название проекта обязательно":delete u.value.projectName}}},template:`
      <DXWizard
        v-model:current-step="currentStep"
        v-model:wizard-data="wizardData"
        :steps="steps"
