import{_ as t}from"./DXTooltip-BRxQMrn3.js";import"./vue.esm-bundler-CzLKT_w4.js";import"./useSize-DIMNv1Ms.js";import"./useVariant-vdsOb9m8.js";import"./InformationCircleIcon-BhW4k1dY.js";import"./CheckCircleIcon-Ch9wT4dl.js";import"./useAnimation-ByVAdqmf.js";const O={title:"Atoms/DXTooltip",component:t,tags:["autodocs","category:feedback"],argTypes:{position:{control:{type:"select"},options:["top","bottom","left","right"]},color:{control:{type:"select"},options:["dark","light","primary","success","danger","warning","info"]},size:{control:{type:"select"},options:["xs","sm","md","lg","xl"]},animation:{control:{type:"select"},options:["fade","fade-scale","slide-up","slide-down","slide-left","slide-right","tooltip-custom"]}}},o={args:{content:"This is a tooltip"},render:c=>({components:{DXTooltip:t},setup(){return{args:c}},template:'<DXTooltip v-bind="args"><button class="px-4 py-2 bg-slate-100 rounded">Hover me</button></DXTooltip>'})},n={render:()=>({components:{DXTooltip:t},template:`
...
}`,...(w=(S=i.parameters)==null?void 0:S.docs)==null?void 0:w.source}}};var W,z,C;l.parameters={...l.parameters,docs:{...(W=l.parameters)==null?void 0:W.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXTooltip
    },
...
}`,...(C=(z=l.parameters)==null?void 0:z.docs)==null?void 0:C.source}}};var L,j,F;p.parameters={...p.parameters,docs:{...(L=p.parameters)==null?void 0:L.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXTooltip
    },
...
}`,...(F=(j=p.parameters)==null?void 0:j.docs)==null?void 0:F.source}}};var M,R,k;a.parameters={...a.parameters,docs:{...(M=a.parameters)==null?void 0:M.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXTooltip
    },
...
}`,...(k=(R=a.parameters)==null?void 0:R.docs)==null?void 0:k.source}}};var I,P,E;r.parameters={...r.parameters,docs:{...(I=r.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
...
}`,...(E=(P=r.parameters)==null?void 0:P.docs)==null?void 0:E.source}}};const q=["Default","Positions","Colors","Sizes","Animations","WithSlotContent","MaxWidth","Combinations","LightTheme"];export{i as Animations,e as Colors,a as Combinations,o as Default,r as LightTheme,p as MaxWidth,n as Positions,s as Sizes,l as WithSlotContent,q as __namedExportsOrder,O as default};
