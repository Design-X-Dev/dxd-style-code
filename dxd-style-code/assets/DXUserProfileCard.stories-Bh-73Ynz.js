...
При \`clickable={true}\` карточка становится кликабельной.
    ...
    `})},y={parameters:{docs:{description:{story:"Карточка профиля с действиями (написать, редактировать)."}}},render:()=>({components:{DXUserProfileCard:p},setup(){return{user:E(x),handleEdit:()=>{console.log("Редактирование профиля")},handleMessage:()=>{console.log("Отправка сообщения")}}},template:`
      <div class="max-w-sm">
        <DXUserProfileCard
          :user="user"
          :show-actions="true"
    ...
    `})},h={parameters:{docs:{description:{story:"Кликабельная карточка профиля."}}},render:()=>({components:{DXUserProfileCard:p},setup(){const e=E(x);return{user:e,handleClick:()=>{console.log("Клик по карточке:",e.value)}}},template:`
      <div class="max-w-sm">
        <DXUserProfileCard
          :user="user"
          :clickable="true"
    ...
    `})},k={parameters:{docs:{description:{story:"Карточки профиля разных размеров."}}},render:()=>({components:{DXUserProfileCard:p},setup(){return{user:E(x)}},template:`
...
}`,...(j=(M=z.parameters)==null?void 0:M.docs)==null?void 0:j.source}}};var N,L,O;y.parameters={...y.parameters,docs:{...(N=y.parameters)==null?void 0:N.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(O=(L=y.parameters)==null?void 0:L.docs)==null?void 0:O.source}}};var q,G,I;h.parameters={...h.parameters,docs:{...(q=h.parameters)==null?void 0:q.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(I=(G=h.parameters)==null?void 0:G.docs)==null?void 0:I.source}}};var W,J,T;k.parameters={...k.parameters,docs:{...(W=k.parameters)==null?void 0:W.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(T=(J=k.parameters)==null?void 0:J.docs)==null?void 0:T.source}}};const Be=["Default","WithActions","Clickable","DifferentSizes"];export{h as Clickable,z as Default,k as DifferentSizes,y as WithActions,Be as __namedExportsOrder,Fe as default};
