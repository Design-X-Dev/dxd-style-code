import{_ as n}from"./DXButton-ChBdj9Dq.js";import{_ as T}from"./DXIcon-BbhqsR95.js";import{r as _}from"./PencilIcon-CpxY3S_F.js";import{r as A}from"./TrashIcon-NtQ19PgI.js";import{r as w}from"./PlusIcon-C_U3AjOX.js";import{r as C}from"./HeartIcon-DvsVISFD.js";import"./vue.esm-bundler-CzLKT_w4.js";import"./useSize-DIMNv1Ms.js";import"./useVariant-vdsOb9m8.js";import"./InformationCircleIcon-BhW4k1dY.js";import"./CheckCircleIcon-Ch9wT4dl.js";import"./useClassComposition-Dym2pzZ_.js";import"./useAnimation-ByVAdqmf.js";const N={title:"Atoms/DXButton",component:n,tags:["autodocs","category:form"],argTypes:{variant:{control:"select",options:["primary","secondary","ghost","outline","success","warning","danger","info","link","soft"],description:"Вариант оформления кнопки"},size:{control:"select",options:["xs","sm","md","lg","xl"],description:"Размер кнопки"},disabled:{control:"boolean",description:"Отключенное состояние"},block:{control:"boolean",description:"Растянуть на всю ширину"},iconOnly:{control:"boolean",description:"Только иконка (квадратная кнопка)"}}},o={args:{variant:"primary"},render:t=>({components:{DXButton:n},setup(){return{args:t}},template:'<DXButton v-bind="args">Кнопка</DXButton>'})},e={render:()=>({components:{DXButton:n},template:`
    ...
    `})},r={args:{disabled:!0},render:t=>({components:{DXButton:n},setup(){return{args:t}},template:'<DXButton v-bind="args">Disabled</DXButton>'})},u={args:{block:!0},render:t=>({components:{DXButton:n},setup(){return{args:t}},template:'<DXButton v-bind="args">Full Width</DXButton>'})},a={render:()=>({components:{DXButton:n,DXIcon:T},setup(){return{PlusIcon:w,TrashIcon:A,PencilIcon:_}},template:`
      <div class="flex items-center gap-4">
        <DXButton>
...
}`,...(f=(v=r.parameters)==null?void 0:v.docs)==null?void 0:f.source}}};var I,z,h;u.parameters={...u.parameters,docs:{...(I=u.parameters)==null?void 0:I.docs,source:{originalSource:`{
  args: {
    block: true
  },
  render: args => ({
...
}`,...(h=(z=u.parameters)==null?void 0:z.docs)==null?void 0:h.source}}};var y,b,S;a.parameters={...a.parameters,docs:{...(y=a.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: () => ({
    components: {
      DXButton,
      DXIcon
...
}`,...(E=(k=i.parameters)==null?void 0:k.docs)==null?void 0:E.source}}};const Q=["Default","Variants","Sizes","Disabled","Block","WithIcon","IconOnly"];export{u as Block,o as Default,r as Disabled,i as IconOnly,s as Sizes,e as Variants,a as WithIcon,Q as __namedExportsOrder,N as default};
