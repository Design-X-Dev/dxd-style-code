...
Переходы между состояниями анимируются через CSS transitions.
    ...
    `})},f={args:{mode:"static",open:!0},parameters:{docs:{description:{story:"Коллапсируемый сайдбар. Используйте контролы для переключения состояния."}}},render:e=>({components:{DXSidebar:a,DXSidebarMenu:u,DXButton:W,DXIcon:q},setup(){return{collapsed:O(!1),args:e,menuSections:r,ChevronLeftIcon:K,ChevronRightIcon:J}},template:`
...
}`,...(L=($=D.parameters)==null?void 0:$.docs)==null?void 0:L.source}}};const Me=["Default","OverlayMode","Collapsible","WithFooter","PushMode"];export{f as Collapsible,m as Default,b as OverlayMode,D as PushMode,h as WithFooter,Me as __namedExportsOrder,Ee as default};
