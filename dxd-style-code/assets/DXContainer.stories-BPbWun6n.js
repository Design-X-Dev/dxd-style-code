import{_ as n}from"./DXContainer-DdAaCCrN.js";import"./vue.esm-bundler-C1fUoNF-.js";import"./useSpacing-BOHUzi8w.js";import"./useClassComposition-Dym2pzZ_.js";const g={title:"Atoms/DXContainer",component:n,tags:["autodocs","category:layout"],parameters:{docs:{description:{component:`
# DXContainer
...
- Для кастомной максимальной ширины используйте CSS классы через \`class\` prop
        `}}},argTypes:{size:{control:"select",options:["sm","md","lg","xl","2xl","full"],description:"Максимальная ширина контейнера. Определяет максимальную ширину контента на больших экранах. Использует Tailwind классы max-w-screen-*.",table:{type:{summary:"string"},defaultValue:{summary:'"lg"'},category:"Layout"}},center:{control:"boolean",description:"Автоматически центрировать контейнер. При true применяет mx-auto для горизонтального центрирования.",table:{type:{summary:"boolean"},defaultValue:{summary:"true"},category:"Behavior"}},padding:{control:"select",options:["none","xs","sm","md","lg","xl"],description:"Горизонтальные отступы (padding-x) контейнера. Создает пространство от краев экрана на мобильных устройствах. Использует систему spacing из useSpacing.",table:{type:{summary:"string"},defaultValue:{summary:'"md"'},category:"Spacing"}}}},u={args:{size:"lg"},parameters:{docs:{description:{story:"Базовый контейнер с размером lg. Автоматически центрируется и ограничивает ширину контента для оптимальной читаемости."}}},render:d=>({components:{DXContainer:n},setup(){return{args:d}},template:'<DXContainer v-bind="args" class="bg-slate-100 py-8"><div class="bg-white p-4 rounded">Content inside container</div></DXContainer>'})},e={parameters:{docs:{description:{story:"Все доступные размеры контейнера. Размер определяет максимальную ширину контента на больших экранах. На мобильных устройствах контейнер занимает всю ширину с учетом padding."}}},render:()=>({components:{DXContainer:n},template:`
      <div class="space-y-4">
    ...
    `})};var a,s,r;u.parameters={...u.parameters,docs:{...(a=u.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    size: 'lg'
  },
  parameters: {
...
}`,...(r=(s=u.parameters)==null?void 0:s.docs)==null?void 0:r.source}}};var t,i,o;e.parameters={...e.parameters,docs:{...(t=e.parameters)==null?void 0:t.docs,source:{originalSource:`{
  parameters: {
    docs: {
      description: {
...
}`,...(o=(i=e.parameters)==null?void 0:i.docs)==null?void 0:o.source}}};const D=["Default","Sizes"];export{u as Default,e as Sizes,D as __namedExportsOrder,g as default};
