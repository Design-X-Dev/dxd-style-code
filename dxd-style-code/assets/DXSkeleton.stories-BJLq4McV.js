import{a as h,o as f,L as g,l as w}from"./vue.esm-bundler-Nfu98kES.js";const e={__name:"DXSkeleton",props:{width:{type:String,default:"100%"},height:{type:String,default:"1rem"},rounded:{type:String,default:"rounded-md"}},setup(o){return(v,y)=>(f(),h("div",{class:w(["animate-pulse bg-slate-200",o.rounded]),style:g({width:o.width,height:o.height}),"data-component":"DXSkeleton"},null,6))}};e.__docgenInfo={exportName:"default",displayName:"DXSkeleton",description:"",tags:{},props:[{name:"width",description:"Ширина",type:{name:"string"},defaultValue:{func:!1,value:'"100%"'}},{name:"height",description:"Высота",type:{name:"string"},defaultValue:{func:!1,value:'"1rem"'}},{name:"rounded",description:"Скругление",type:{name:"string"},defaultValue:{func:!1,value:'"rounded-md"'}}],sourceFiles:["/Users/lea_alex/Projects/1_DEVELOP/0_DESIGN_X_DEV/dxd-style-code/src/components/atoms/DXSkeleton/DXSkeleton.vue"]};const x={title:"Atoms/DXSkeleton",component:e,tags:["autodocs"]},n={render:()=>({components:{DXSkeleton:e},template:'<DXSkeleton class="h-4 w-48" />'})},t={render:()=>({components:{DXSkeleton:e},template:'<DXSkeleton class="h-12 w-12 rounded-full" />'})},s={render:()=>({components:{DXSkeleton:e},template:`
