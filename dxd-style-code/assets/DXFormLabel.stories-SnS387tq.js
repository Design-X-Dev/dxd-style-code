import{_ as r}from"./DXFormLabel-CkXlkm95.js";import"./vue.esm-bundler-CzLKT_w4.js";import"./DXIcon-BbhqsR95.js";import"./useSize-DIMNv1Ms.js";import"./useAnimation-ByVAdqmf.js";import"./ExclamationCircleIcon-CzLk2qiN.js";import"./CheckCircleIcon-Ch9wT4dl.js";const k={title:"Atoms/DXFormLabel",component:r,tags:["autodocs","category:form"],argTypes:{label:{control:"text",description:"Label text"},error:{control:"text",description:"Error message"},helper:{control:"text",description:"Helper text"},success:{control:"text",description:"Success message"},required:{control:"boolean",description:"Show required asterisk"},showValidationIcon:{control:"boolean",description:"Show validation icon in messages"},maxLength:{control:"number",description:"Maximum length for character count"},currentLength:{control:"number",description:"Current length for character count"},showCount:{control:"boolean",description:"Show character count"}}},t={args:{label:"Email Address",helper:"We will never share your email with anyone else."},render:e=>({components:{DXFormLabel:r},setup(){return{args:e}},template:`
...
}`,...(L=(f=a.parameters)==null?void 0:f.docs)==null?void 0:L.source}}};var w,D,y;s.parameters={...s.parameters,docs:{...(w=s.parameters)==null?void 0:w.docs,source:{originalSource:`{
  args: {
...
}`,...(y=(D=s.parameters)==null?void 0:D.docs)==null?void 0:y.source}}};var F,X,v;l.parameters={...l.parameters,docs:{...(F=l.parameters)==null?void 0:F.docs,source:{originalSource:`{
  args: {
    label: 'Description',
    required: true,
